...
const en: Translations = {
  ...
  landing_stat_spin: "Daily",
  landing_stat_spin_label: "Spin & Win",
  ...
  // Spin Wheel
  spin_title: "Spin & Win",
  spin_sub: "Spin the wheel daily for a chance to win bonus points!",
  spin_spin_btn: "Spin the Wheel!",
  spin_spinning: "Spinning...",
  spin_already_spun: "Already Spun Today",
  spin_come_back: "Come back tomorrow for your next spin!",
...
const ar: Translations = {
  ...
  landing_stat_spin: "يومياً",
  landing_stat_spin_label: "عجلة الحظ",
  ...
  // Spin Wheel
  spin_title: "عجلة الحظ",
  spin_sub: "أدر العجلة يومياً للفوز بنقاط إضافية!",
  spin_spin_btn: "أدر العجلة!",
  spin_spinning: "جاري الدوران...",
  spin_already_spun: "لقد أدرت العجلة اليوم",
  spin_come_back: "عد غداً للدوران مجدداً!",
